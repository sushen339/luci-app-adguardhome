...
doupx(){
	...
	*)
	...
	$downloader /tmp/upx-${upx_latest_ver}-${Arch}_linux.tar.xz "https://gh-proxy.net/github.com/upx/upx/releases/download/v${upx_latest_ver}/upx-${upx_latest_ver}-${Arch}_linux.tar.xz" 2>&1
	#tar xvJf
